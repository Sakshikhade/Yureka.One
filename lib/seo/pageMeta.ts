...
export const staticPageMeta: Record<string, PageMeta> = {
  '/': {
    title: "Yureka.Money | India's AI Wealth OS — Spend, Earn Gold",
    description:
      "Turn everyday spending into 24K digital gold. Yureka's AI concierge orders for you, earns Yureka Goldback rewards up to 16% ROI, and builds your credit profile automatically.",
    ogTitle: "Yureka.Money — Spend like always. Build wealth by default.",
    ogDescription:
    ...
    keywords: [
      ...
      'AI money manager india', 'yureka money', 'goldback rewards', 'digital gold cashback',
  ...
  '/brands': {
    title: 'Brand Explorer | 80+ Partner Brands for Card Rewards | Yureka.Money',
    description:
  ...
  '/blogs': {
    title: 'Learn: Digital Gold, AI Shopping & Credit | Yureka.Money',
    description:
  ...
  '/by-everyone-for-everyone': {
    title: 'Community Intelligence | Crowd-Sourced Credit Card Data | Yureka.Money',
    description:
  ...
  '/privacy-policy': {
    ...
    description:
      'How Yureka.Money collects, uses, and protects your personal and financial data — covering transaction intelligence, DPDP consent, data retention, and your rights as a user.',
  ...
  '/terms-of-service': {
    ...
    description:
      'The terms governing your use of Yureka.Money, including account eligibility, Yureka Goldback rewards, AI concierge usage, and LSP data-sharing rules.',
    keywords: ['yureka terms of service', 'yureka money terms and conditions'],
  },
  '/security-protocol': {
    title: 'Security Protocol | Yureka.Money Infrastructure',
    description:
  ...
  '/free-tools': {
    title: 'Free Tools | Rewards & Gold Calculator | Yureka.Money',
    description:
      'Free calculators from Yureka.Money — estimate cashback-to-gold growth, compare credit card reward yields, and plan your spending strategy without signing up.',
    keywords: [
  ...
  '/manifesto': {
    ...
    description:
      "Why Yureka.Money exists: a Wealth OS built for India's power shoppers who treat every transaction as an opportunity to earn digital gold and build credit — not just collect dead points.",
    keywords: ['yureka manifesto', 'wealth operating system india', 'power shopper philosophy'],
  },
  '/jobs': {
    title: "Careers | Join Yureka.Money — India's Wealth OS",
    description:
      "Help build India's first AI-native Wealth Operating System. Explore open roles at Yureka.Money across engineering, AI, design, and growth.",
  ...
  '/rewards-calculator': {
    title: 'Rewards Transfer Calculator | Yureka.Money',
    description:
  ...
  '/categories': {
    title: 'Card Categories | Browse by Lifestyle | Yureka.Money',
    description:
  ...
  '/compare': {
    title: 'Credit Card Comparisons | Side-by-Side Analysis | Yureka.Money',
    description:
  ...
  '/join-waitlist': {
    title: 'Join Yureka — Earn Gold on Every Order | Yureka.Money',
    description:
      "Get early access to Yureka.Money — India's AI Wealth OS. Earn Yureka Goldback on every transaction, order via AI concierge, and build credit automatically. Invite-gated access.",
    keywords: [
      'yureka waitlist', 'join yureka money', 'early access AI wealth app india',
      'earn gold on spending app india',
    ],
  },
  '/login': {
    title: 'Sign In | Yureka.Money',
    description: 'Sign in to your Yureka.Money account to track Goldback rewards, manage your AI concierge, and access your personalized dashboard.',
    robots: 'noindex, follow',
  },
  '/waiting': {
    title: 'Waitlist Status | Yureka.Money',
    description: 'Check the status of your Yureka.Money waitlist application.',
    robots: 'noindex, follow',
  },
  '/admin': {
    title: 'Admin | Yureka.Money',
  ...
  '/credit': {
    title: 'Build Credit From Your Spending | Yureka.Money',
    description:
...
export function getCategoryPageMeta(slug: string): PageMeta {
  ...
  return {
    title: `Best ${name} Credit Cards in India ${new Date().getFullYear()} | Yureka.Money`,
