        ...
        <div className="bg-cream min-h-screen text-ink pb-32">
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                        ...
                        <div className="text-left md:text-right">
                            ...
                            <p className="text-sm font-mono mt-1 text-ink/60 border-b border-clay inline-block pb-1">April 2026</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto px-6 pt-16 md:pt-24 font-serif text-lg md:text-xl leading-relaxed text-ink/80 space-y-16">
                ...
                <section className="space-y-6">
                    <h2 className="text-3xl font-bold uppercase tracking-tight text-ink border-b-2 border-black pb-4">1. Elevate the Discourse</h2>
                    <p>
                    ...
                    <ul className="space-y-4 list-none pl-0">
                        <li className="pl-6 relative">
                            ...
                            <strong className="text-ink tracking-tight uppercase text-sm mr-2">Substantive Value:</strong> Before posting a review or a strategy, ask yourself if it adds verifiable, tactical value to the community.
                        </li>
                        <li className="pl-6 relative">
                            <span className="absolute left-0 top-1 text-clay font-bold">&bull;</span>
                            <strong className="text-ink tracking-tight uppercase text-sm mr-2">Factual Accuracy:</strong> Speculation regarding RBI regulations, bank terms, or credit scoring algorithms must be clearly marked as such. Do not present financial rumors as fact.
                        </li>
                        <li className="pl-6 relative">
                            <span className="absolute left-0 top-1 text-clay font-bold">&bull;</span>
                            <strong className="text-ink tracking-tight uppercase text-sm mr-2">Professionalism:</strong> Engaging in ad hominem attacks, trolling, or aggressive debate diminishes the quality of our collective intelligence and will not be tolerated.
                        </li>
                    </ul>
                </section>

                <section className="space-y-6">
                    <h2 className="text-3xl font-bold uppercase tracking-tight text-ink border-b-2 border-black pb-4">2. Zero Tolerance for Scams & Solicitation</h2>
                    <p>
                ...
                <section className="space-y-6">
                    <h2 className="text-3xl font-bold uppercase tracking-tight text-ink border-b-2 border-black pb-4">3. Protection of Confidentiality</h2>
                    <p>
                ...
                <section className="space-y-6">
                    <h2 className="text-3xl font-bold uppercase tracking-tight text-ink border-b-2 border-black pb-4">4. Integrity of Review Data</h2>
                    <p>
                    ...
                    <ul className="space-y-4 list-none pl-0">
                        <li className="pl-6 relative">
                            <span className="absolute left-0 top-1 text-clay font-bold">&bull;</span>
                            <strong className="text-ink tracking-tight uppercase text-sm mr-2">Be Authentic:</strong> Do not submit fake reviews to artificially inflate or deflate a financial product's standing.
                        </li>
                        <li className="pl-6 relative">
                            <span className="absolute left-0 top-1 text-clay font-bold">&bull;</span>
                            <strong className="text-ink tracking-tight uppercase text-sm mr-2">Disclose Bias:</strong> If you are employed by an issuing bank or networked entity, you must disclose this when discussing competitor products.
                        </li>
                    </ul>
                </section>
                ...
                <section className="border-t-4 border-black pt-16 mt-16 text-center space-y-8">
                     ...
                     <div className="pt-8">
                         <h3 className="text-2xl font-bold uppercase tracking-tight text-ink mb-4">See a Violation?</h3>
                         <p className="italic text-ink/60 mb-6">If you witness behavior that violates these principles, please report it immediately to our security desk.</p>
