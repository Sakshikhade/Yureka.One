...
const tweets = [
  {
    ...
    verified: true,
    content: (<p>@jupytercredit is killing it with AI matching. Found me a card with 5% cashback on Swiggy - literally ₹12K saved this year!</p>),
    date: 'Feb 23, 2025',
  },
  {
    id: '2',
    ...
    verified: true,
    content: (<p>Was hunting for a travel card and discovered @jupytercredit. Can't believe the AI matched me with a card that has unlimited lounge access.</p>),
    date: 'Jan 30, 2025',
  },
  {
    id: '3',
    ...
    verified: true,
    content: (<p>@jupytercredit we desperately need the Chrome extension for UPI payments too! Best fintech tool in India right now.</p>),
    date: 'Jan 29, 2025',
  },
];

const TweetCard = React.memo<{ tweet: any }>(({ tweet }) => (
  <div className="bg-white border-r border-black/10 p-6 md:p-8 w-[300px] md:w-[450px] flex-shrink-0 flex flex-col h-full hover:bg-[#F5F5F0] transition-colors group">
     ...
     <div className="mb-6 text-black/80 text-lg md:text-xl font-serif italic leading-relaxed">"{tweet.content}"</div>
     <div className="mt-auto pt-4 border-t border-black/5 flex justify-between text-black/30 text-xs md:text-sm uppercase tracking-widest font-bold">
