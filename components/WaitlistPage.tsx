    ...
    <div className="min-h-screen bg-cream pt-4 md:pt-8 pb-32 px-6 overflow-hidden font-serif selection:bg-[#047857]/20">
         ...
         <div className="w-full max-w-4xl mx-auto relative z-10 transition-all duration-1000">
             ...
             <div className="relative group">
                 ...
                 <div className="relative bg-cream/60 backdrop-blur-2xl p-6 md:p-8 rounded-[3rem] border border-ink/5 shadow-2xl">
                     
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                         <button 
                            onClick={() => setRole('user')}
                            className={`group/role p-6 md:p-8 rounded-3xl border-2 transition-all duration-500 text-left ${role === 'user' ? 'bg-[#242424] border-ink text-cream shadow-2xl scale-[1.02]' : 'bg-cream/40 border-ink/5 text-[#242424]/40 hover:border-clay/20 hover:text-[#242424]'}`}
                         >
                         ...
                         <button 
                            ...
                            className={`group/role p-6 md:p-8 rounded-3xl border-2 transition-all duration-500 text-left ${role === 'partner' ? 'bg-[#242424] border-ink text-cream shadow-2xl scale-[1.02]' : 'bg-cream/40 border-ink/5 text-[#242424]/40 hover:border-clay/20 hover:text-[#242424]'}`}
                         >
                             <div className="flex justify-between items-start mb-10">
                     ...
                     {role && (
                         <div className="space-y-12 animate-fade-in">
                                     ...
                                     <div className="flex flex-wrap gap-3">
                                         {['Travel', 'Dining', 'Shopping', 'Business'].map(cat => (
                                             <button 
                                                ...
                                                className={`px-6 md:px-8 py-4 md:py-6 rounded-full border text-lg md:text-xl font-bold uppercase tracking-[0.2em] transition-all ${formData.category === cat ? 'bg-[#047857] border-clay text-cream' : 'bg-transparent border-ink/10 text-[#242424]/40 hover:border-ink/20'}`}
                                             >
                                                 {cat}
                                             </button>
                                         ))}
                             ...
                             <button 
                                ...
                                className="w-full bg-[#242424] text-cream px-6 md:px-8 py-4 md:py-6 rounded-2xl flex items-center justify-center gap-6 group hover:bg-[#047857] transition-all duration-700 shadow-2xl active:scale-95 disabled:opacity-50"
                             >
