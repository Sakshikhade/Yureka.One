...
const FAQItem: React.FC<FAQItemProps> = ({ icon: Icon, question, answer }) => {
  ...
  return (
    <div className={`bg-white/[0.02] backdrop-blur-md rounded-3xl border transition-all duration-500 overflow-hidden ${isOpen ? 'border-white/10 shadow-xl scale-[1.01]' : 'border-white/5 shadow-sm'}`}>
      <button 
      ...
      >
        <div className="px-8 pb-10 pl-16 md:pl-[6.5rem] pr-12">
            ...
            <p className="text-white/40 text-lg leading-relaxed font-serif italic">{answer}</p>
        </div>
      </div>
    </div>
  );
                         ...
                         <div className="space-y-12 animate-fade-in">
                             <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                                 <div className="space-y-2">
                                     <label className="text-[10px] font-bold text-white/20 uppercase tracking-[0.4em]">First Identity</label>
                                     <input 
                                 ...
                                 <div className="space-y-2">
                                     <label className="text-[10px] font-bold text-white/20 uppercase tracking-[0.4em]">Last Identity</label>
                                     <input 
                             ...
                             <div className="space-y-2">
                                 <label className="text-[10px] font-bold text-white/20 uppercase tracking-[0.4em]">Digital Address (Email)</label>
                                 <input 
                             ...
                             {role === 'user' ? (
                                 <div className="space-y-4">
                                     <label className="text-[10px] font-bold text-white/20 uppercase tracking-[0.4em]">Primary Interest</label>
                                 ...
                                 <div className="space-y-2">
                                     <label className="text-[10px] font-bold text-white/20 uppercase tracking-[0.4em]">Organization</label>
                                     <input 
