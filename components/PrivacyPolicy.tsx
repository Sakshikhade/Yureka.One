        ...
        <div className="bg-cream min-h-screen text-[#242424] pb-32">
            ...
            <div className="max-w-4xl mx-auto px-6 pt-16 md:pt-24 font-serif text-lg md:text-xl leading-relaxed text-[#242424]/80 space-y-16">
                ...
                <section className="space-y-6">
                    <h2 className="text-3xl font-bold uppercase tracking-tight text-[#242424] border-b-2 border-black pb-4">Collection of Information</h2>
                    ...
                    <ul className="space-y-4 list-none pl-0">
                        <li className="pl-6 relative">
                            ...
                            <strong className="text-[#242424] tracking-tight uppercase text-sm mr-2">User Provided Information:</strong> When you register or use Yureka.Money, it is necessary to provide personal details such as your name, email address, contact number, and other relevant information.
                        </li>
                        <li className="pl-6 relative">
                            <span className="absolute left-0 top-1 text-[#047857] font-bold">&bull;</span>
                            <strong className="text-[#242424] tracking-tight uppercase text-sm mr-2">Information Generated Through Use:</strong> We gather data about the services you use on Yureka.Money, your interactions with our platform, transaction details, and other usage metrics to enhance your experience.
                        </li>
                        <li className="pl-6 relative">
                            <span className="absolute left-0 top-1 text-[#047857] font-bold">&bull;</span>
                            <strong className="text-[#242424] tracking-tight uppercase text-sm mr-2">Information from Third Parties:</strong> With your explicit consent, we may obtain information from third parties to authenticate your identity, provide specific services, or personalize your experience.
                        </li>
                    </ul>
                    <p className="italic text-base text-[#242424]/60 border-l-2 border-clay pl-4 mt-6">
                        The nature and amount of information collected depends upon the type of interaction between the company and the user.
                    </p>
                </section>

                <section className="space-y-6">
                    <h2 className="text-3xl font-bold uppercase tracking-tight text-[#242424] border-b-2 border-black pb-4">Use of Information</h2>
                    ...
                    <div className="bg-[#242424] text-cream p-8 mt-8 border border-black/10 shadow-xl relative overflow-hidden">
                        <div className="absolute top-0 left-0 w-1 h-full bg-[#047857]"></div>
                ...
                <section className="space-y-6">
                    <h2 className="text-3xl font-bold uppercase tracking-tight text-[#242424] border-b-2 border-black pb-4">Disclosure of Information</h2>
                    ...
                    <p className="font-bold underline text-[#242424]">We do not sell or lease your information to third parties for marketing purposes.</p>
                </section>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    <section className="space-y-4">
                        <h2 className="text-3xl font-bold uppercase tracking-tight text-[#242424] border-b-2 border-black pb-4">Cookies</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-3xl font-bold uppercase tracking-tight text-[#242424] border-b-2 border-black pb-4">Security</h2>
                        <p className="text-base">
                ...
                <section className="space-y-8">
                    <h2 className="text-3xl font-bold uppercase tracking-tight text-[#242424] border-b-2 border-black pb-4">Data Retention</h2>
                    <p>
                    ...
                    <div className="overflow-x-auto border border-black/10">
                        <table className="w-full text-left text-sm md:text-base border-collapse">
                            <thead className="bg-[#242424] text-cream">
                                <tr>
                            ...
                            <tbody className="divide-y divide-black/10 bg-cream">
                                <tr className="hover:bg-black/5 transition-colors">
                                    <td className="p-4 font-bold text-[#242424]">Registration <span className="block font-normal text-xs text-[#242424]/50 mt-1">(Name, Email, Phone)</span></td>
                                ...
                                <tr className="hover:bg-black/5 transition-colors">
                                    <td className="p-4 font-bold text-[#242424]">Transaction Data <span className="block font-normal text-xs text-[#242424]/50 mt-1">(GVs, bills, rewards)</span></td>
                                ...
                                <tr className="hover:bg-black/5 transition-colors">
                                    <td className="p-4 font-bold text-[#242424]">Usage Analytics <span className="block font-normal text-xs text-[#242424]/50 mt-1">(Non-personal)</span></td>
                                    <td className="p-4 italic">2 years</td>
                                    <td className="p-4 text-xs font-mono">Service improvement<br/>Trigger: Automated purge</td>
                                </tr>
                                <tr className="hover:bg-black/5 transition-colors">
                                    <td className="p-4 font-bold text-[#242424]">Logs & Events <span className="block font-normal text-xs text-[#242424]/50 mt-1">(Security)</span></td>
                                ...
                                <tr className="hover:bg-black/5 transition-colors">
                                    <td className="p-4 font-bold text-[#242424]">KYC Documents <span className="block font-normal text-xs text-[#242424]/50 mt-1">(Financial docs)</span></td>
                ...
                <section className="space-y-6">
                    <h2 className="text-3xl font-bold uppercase tracking-tight text-[#242424] border-b-2 border-black pb-4">Consent Notice <span className="text-sm font-mono tracking-normal text-[#047857] ml-2">Per DPDP Rule 3</span></h2>
                    ...
                    <p className="bg-cream p-6 border border-black/10 italic text-base">
                    ...
                    <div className="bg-black/5 p-6 md:p-8 rounded-sm">
                        ...
                        <ul className="space-y-3 text-base">
                            <li className="flex items-start gap-3">
                                <span className="text-[#047857] mt-1">1.</span>
                                <span>Email <a href="mailto:contact@Yureka.Money" className="text-[#047857] underline font-bold">contact@Yureka.Money</a> with "Withdraw Consent - [Your Registered Email]"</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <span className="text-[#047857] mt-1">2.</span>
                                <span>Deletion request erases all data within 72 hours (except legal retention)</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <span className="text-[#047857] mt-1">3.</span>
                ...
                <section className="border-t-4 border-black pt-16 mt-16 text-center space-y-8">
                     ...
                     <div className="pt-8">
                         <h3 className="text-2xl font-bold uppercase tracking-tight text-[#242424] mb-4">Questions or Concerns?</h3>
                         <p className="italic text-[#242424]/60 mb-6">If you have any questions, concerns, or requests regarding this Privacy Policy or your personal information, please contact us.</p>
