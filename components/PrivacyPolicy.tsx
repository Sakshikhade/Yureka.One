        ...
        <div className="bg-[#0a0a0a] min-h-screen text-white pb-32 selection:bg-[#34d399] selection:text-[#0a0a0a]">
            ...
            <div className="max-w-4xl mx-auto px-6 pt-16 md:pt-24 font-serif text-lg md:text-xl leading-relaxed text-white/80 space-y-16">
                ...
                <section className="space-y-6">
                    ...
                    <p className="italic text-base text-white/40 border-l-2 border-[#34d399]/30 pl-4 mt-6">
                ...
                <section className="space-y-6">
                    ...
                    <div className="bg-white/5 text-white/80 p-8 md:p-12 mt-8 border border-white/10 rounded-[2rem] shadow-2xl relative overflow-hidden backdrop-blur-sm">
                        <div className="absolute top-0 left-0 w-1.5 h-full bg-[#34d399] shadow-[0_0_15px_#34d399]"></div>
                ...
                <section className="space-y-6">
                    ...
                    <p className="font-bold underline text-[#34d399]">We do not sell or lease your information to third parties for marketing purposes.</p>
                </section>
                        ...
                        <table className="w-full text-left text-sm md:text-base border-collapse">
                            ...
                            <tbody className="divide-y divide-white/5">
                                <tr className="hover:bg-white/5 transition-colors">
                                    ...
                                    <td className="p-4 text-[10px] font-mono text-[#34d399]/60">Service delivery, fraud prevention<br/>Trigger: Account deletion</td>
                                </tr>
                                <tr className="hover:bg-white/5 transition-colors">
                                    ...
                                    <td className="p-4 text-[10px] font-mono text-[#34d399]/60">RBI/PMLA compliance<br/>Trigger: End of legal hold</td>
                                </tr>
                                <tr className="hover:bg-white/5 transition-colors">
                                    ...
                                    <td className="p-4 text-[10px] font-mono text-[#34d399]/60">Service improvement<br/>Trigger: Automated purge</td>
                                </tr>
                                <tr className="hover:bg-white/5 transition-colors">
                                    ...
                                    <td className="p-4 text-[10px] font-mono text-[#34d399]/60">Breach investigation<br/>Trigger: Annual cycle</td>
                                </tr>
                                <tr className="hover:bg-white/5 transition-colors">
                                    ...
                                    <td className="p-4 text-[10px] font-mono text-[#34d399]/60">Regulatory audits<br/>Trigger: Requirement expiry</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <section className="space-y-6">
                    <h2 className="text-3xl font-heading font-extrabold uppercase tracking-tight text-white border-b-2 border-white/10 pb-4">Consent Notice <span className="text-[10px] font-mono tracking-[0.2em] text-[#34d399] ml-4 uppercase">Per DPDP Rule 3</span></h2>
                    ...
                    <div className="bg-white/5 p-8 md:p-12 rounded-[2rem] border border-white/10 backdrop-blur-sm shadow-2xl">
                        ...
                        <ul className="space-y-6 text-base">
                            <li className="flex items-start gap-4">
                                <span className="text-[#34d399] font-bold text-xl leading-none">01.</span>
                                <span className="text-white/70">Email <a href="mailto:contact@Yureka.Money" className="text-[#34d399] underline font-bold decoration-1 underline-offset-4">contact@Yureka.Money</a> with <br /><span className="text-white italic">"Withdraw Consent - [Your Registered Email]"</span></span>
                            </li>
                            <li className="flex items-start gap-4">
                                <span className="text-[#34d399] font-bold text-xl leading-none">02.</span>
                                <span className="text-white/70">Deletion request erases all data within 72 hours (except legal retention)</span>
                            </li>
                            <li className="flex items-start gap-4">
                                <span className="text-[#34d399] font-bold text-xl leading-none">03.</span>
                ...
                <section className="border-t-4 border-white pt-16 mt-16 text-center space-y-10">
                     ...
                     <div className="pt-8">
                         ...
                         <a href="mailto:contact@yureka.money" className="inline-flex items-center gap-3 bg-white text-[#0a0a0a] px-10 py-5 rounded-full uppercase font-bold tracking-[0.2em] text-[10px] hover:bg-[#34d399] hover:scale-105 transition-all shadow-2xl">
