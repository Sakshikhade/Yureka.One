...
import { 
    Search, RefreshCw, AlertCircle, TrendingUp, DollarSign, 
...
const Expenses: React.FC = () => {
        ...
        try {
            ...
            if (data.transactions) {
                ...
                const filtered = (data.transactions || []).filter((tx: ParsedTransaction) => {
                    ...
                    if (type && type !== 'transaction') return false;
    ...
    // Computes expense summary metrics
    const metrics = useMemo(() => {
        if (transactions.length === 0) return { total: '₹ 0', count: 0, average: '₹ 0', topMerchant: 'N/A' };
        ...
        <div className="space-y-12">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
                <div className="relative w-full sm:w-96">
                    ...
                    <input
                        type="text"
                        placeholder="Search standard expenses..."
                        value={searchQuery}
            ...
            >
                <div className="p-8 border-b border-white/5 flex items-center justify-between">
                    <h3 className="text-lg font-black uppercase tracking-[0.2em] text-white">Expenses Ledger</h3>
                ...
                <div className="overflow-x-auto">
                    {filteredTransactions.length === 0 ? (
                        <div className="py-20 text-center flex flex-col items-center justify-center">
                            ...
                            <p className="text-white/40 font-serif italic text-lg">No synchronized expenses found.</p>
                        </div>
                    ) : (
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="border-b border-white/5 text-[9px] font-black uppercase tracking-[0.3em] text-white/30 bg-white/[0.01]">
                                    <th className="py-6 px-8">Merchant</th>
                                    <th className="py-6 px-8">Spend Value</th>
