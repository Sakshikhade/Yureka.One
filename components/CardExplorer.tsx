...
const CardExplorer: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0a] pb-32 overflow-x-hidden text-white/90 selection:bg-[#34d399] selection:text-[#0a0a0a]">
            ...
            <div className="relative pt-24 md:pt-40 pb-20 border-b border-white/5 overflow-hidden">
                ...
                <div className="max-w-[1400px] mx-auto px-6 relative z-10 text-center">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        <p className="text-[10px] font-bold uppercase tracking-[0.4em] text-[#34d399] mb-6">Credit Card Intelligence</p>
                        <h1 className="text-5xl sm:text-7xl md:text-8xl font-heading font-extrabold text-white leading-[0.9] tracking-tighter mb-8">
                            Find Your<br /><span className="text-[#34d399] italic font-serif font-light">Perfect Card.</span>
                        </h1>
            ...
            <div className="max-w-[1400px] mx-auto px-6 py-12">
                <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-16">
                    <div className="relative w-full max-w-md group">
                        <Search className="absolute left-6 top-1/2 -translate-y-1/2 text-white/40 group-focus-within:text-[#34d399] transition-colors" size={18} />
                ...
                {filteredCards.length === 0 && (
                    <div className="text-center py-48">
                        ...
                        <button onClick={() => { setSelectedBanks([]); setSelectedCategories([]); setSearchQuery(''); setCardType('All Types'); }}
                            className="mt-8 text-[#34d399] text-[11px] font-bold uppercase tracking-widest hover:underline">Reset Filters</button>
                    </div>
                )}
            </div>
        </div>
