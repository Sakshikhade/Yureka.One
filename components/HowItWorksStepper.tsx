...
const HowItWorksStepper: React.FC = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="w-full bg-paper border-y border-ink/10 relative overflow-hidden"
    >
      {/* Background Radiating Rings */}
      ...
      <div className="max-w-[1400px] mx-auto px-6 relative z-10">
        {/* Section header */}
        <div className="py-16 lg:py-20 text-center lg:text-left">
          <p className="text-[10px] text-[#242424]/30 uppercase tracking-[0.3em] font-bold mb-3 font-sans">How does it work?</p>
        ...
        {/* Sticky phone + scrolling steps */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-start pb-20">

          {/* LEFT: Sticky Phone */}
          <div className="lg:col-span-5 xl:col-span-5 flex justify-center lg:sticky lg:top-28">
            <div className="relative w-[240px] sm:w-[260px] h-[500px] sm:h-[530px] rounded-[3rem] border-[8px] border-white bg-cream shadow-[0_30px_80px_-15px_rgba(0,0,0,0.15)] overflow-hidden ring-1 ring-ink/5 shrink-0">
               {/* Notch */}
               ...
               <div className="absolute bottom-4 left-0 right-0 flex justify-center gap-1.5 z-50">
                 {STEPS.map((s) => (
                   <motion.div
                     key={s.id}
                     animate={{ width: activeStep === s.id ? 20 : 6, opacity: activeStep === s.id ? 1 : 0.3 }}
          ...
          <div className="lg:col-span-7 xl:col-span-7 flex flex-col gap-0">
            {STEPS.map((step, index) => {
              ...
              return (
                <div
                  ...
                  className="py-10 border-b border-ink/5 last:border-0 cursor-pointer group"
                >
                  <div className="flex gap-6 items-start">
                    ...
                    <div className="flex-1 min-w-0">
                      <motion.p
                        animate={{ opacity: isActive ? 0.5 : 0.3 }}
                        className="text-[10px] font-bold uppercase tracking-[0.3em] text-[#047857] mb-2"
                      >
                        {step.label}
                      </motion.p>
                      <motion.p
                        animate={{
                          ...
                          color: isActive ? '#242424' : '#242424',
                        }}
                        transition={{ duration: 0.3 }}
                        className={`text-base md:text-lg leading-relaxed font-sans transition-all duration-300 ${isActive ? 'font-medium' : 'font-normal'}`}
                      >
                        {step.title}
                      </motion.p>
                      ...
                      <motion.div
                        ...
                        className="h-0.5 bg-[#047857]/30 mt-4 origin-left rounded-full"
                        style={{ width: '40%' }}
                      />
                    </div>
                  </div>
