...
const OurStory: React.FC = () => {
  return (
    <div className="min-h-screen bg-[#F2EFE9] pt-4 md:pt-8 pb-20 font-sans text-[#242424] px-2 md:px-6">
                    ...
                    <div className="w-full aspect-[4/3] bg-black/5 relative overflow-hidden grayscale hover:grayscale-0 transition-all duration-700">
                        ...
                        />
                         <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/50 to-transparent p-4">
                            <p className="text-cream text-xs font-bold uppercase tracking-widest">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 min-h-[600px]">
            ...
            <div className="lg:col-span-2 border-r border-black/10 p-4 md:p-6">
                 <FadeInSection delay={100}>
                     <div className="mb-8">
                         <p className="text-[#047857] font-serif text-xl italic mb-1">Editor's Note</p>
                    ...
                    <FadeInSection delay={200}>
                        <div className="w-full aspect-[21/9] bg-black/5 relative grayscale hover:grayscale-0 transition-all duration-700 overflow-hidden">
                             <ImageWithLoader 
                                ...
                                alt="Fintech"
                             />
                             <div className="absolute bottom-0 left-0 bg-cream/90 backdrop-blur-sm p-2 text-[10px] font-bold uppercase tracking-widest border-t border-r border-black/10">
                    ...
                    <div className="md:col-span-8">
                        <FadeInSection delay={300}>
                            <div className="flex items-center gap-2 mb-4">
                               <span className="bg-[#047857] text-cream text-[9px] font-bold uppercase px-2 py-1 rounded-sm">Cover Story</span>
                            </div>
                    ...
                    <div className="md:col-span-4 bg-black/5 p-5 border-t-4 border-black">
                        <FadeInSection delay={400}>
                            ...
                            <div className="mt-6 pt-4 border-t border-black/10">
                                <Quote size={24} className="text-[#047857] mb-2" />
            ...
            <FadeInSection>
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 border-t-4 border-black pt-12">
                    <div className="lg:col-span-4">
                        <span className="text-[#047857] font-bold text-xs uppercase tracking-widest block mb-4">Neural Dispatch 01</span>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 border-t-2 border-black/10 pt-12">
                    <div className="lg:col-span-7 border-r border-black/10 pr-12">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                            <div className="space-y-4">
                                <h4 className="font-bold text-xs uppercase tracking-widest bg-[#047857] text-cream inline-block px-2 py-1">Strategy A</h4>
                            ...
                            <div className="space-y-4">
                                <h4 className="font-bold text-xs uppercase tracking-widest bg-teal text-cream inline-block px-2 py-1">Strategy B</h4>
                                <p className="font-serif text-lg leading-snug">
            ...
            <FadeInSection>
                <div className="relative border-4 border-black p-8 md:p-16 overflow-hidden">
                    ...
                    <div className="max-w-3xl mx-auto text-center">
                        <span className="text-[#047857] font-bold text-xs uppercase tracking-[0.4em] mb-4 block">Registry Audit / Rules</span>
            ...
            <FadeInSection>
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 border-t-2 border-black/10 pt-12">
                     <div className="lg:col-span-5 order-2 lg:order-1">
                        <div className="w-full aspect-square bg-[#242424] text-cream p-12 flex flex-col justify-between group overflow-hidden relative">
                             ...
                             <div className="text-[#047857] font-blackletter text-[10rem] absolute -bottom-10 -right-10 opacity-10 group-hover:rotate-12 transition-transform duration-1000">$</div>
                        </div>
                    </div>
                    <div className="lg:col-span-7 order-1 lg:order-2 flex flex-col justify-center">
                        <span className="text-[#047857] font-bold text-xs uppercase tracking-widest block mb-4">Financial Dispatch 04</span>
            ...
            <FadeInSection>
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 border-y-2 border-black py-16 bg-cream shadow-2xl">
                    ...
                    <div className="lg:col-span-4 px-12 border-r border-black/5">
                        <h4 className="font-bold text-xs uppercase tracking-[0.3em] mb-4 text-[#047857]">Neural Engine</h4>
                        <p className="font-serif text-sm leading-relaxed">
                            Our proprietary LLM-driven core parses bank policy PDF changes in real-time. No manual entry, no stale data.
                        </p>
                    </div>
                    <div className="lg:col-span-4 px-12 border-r border-black/5">
                        <h4 className="font-bold text-xs uppercase tracking-[0.3em] mb-4 text-[#047857]">Real-Time Sync</h4>
                        <p className="font-serif text-sm leading-relaxed">
                    ...
                    <div className="lg:col-span-4 px-12">
                        <h4 className="font-bold text-xs uppercase tracking-[0.3em] mb-4 text-[#047857]">React Architecture</h4>
                        <p className="font-serif text-sm leading-relaxed">
        ...
        <section id="security" className="scroll-mt-32">
            <FadeInSection>
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 border-t border-black/10 pt-12">
                    <div className="lg:col-span-6 bg-[#047857]/5 p-12 border-l-8 border-clay">
                        ...
                        <div className="space-y-6 font-serif text-lg leading-relaxed">
                            ...
                            <ul className="space-y-4">
                                <li className="flex gap-4 items-start">
                                    <span className="w-6 h-6 rounded-full bg-[#047857] text-cream flex-shrink-0 flex items-center justify-center text-[10px] font-bold">01</span>
                                    <span>**AES-256 Encryption**: Your data is encrypted at rest and in transit.</span>
                                </li>
                                <li className="flex gap-4 items-start">
                                    <span className="w-6 h-6 rounded-full bg-[#047857] text-cream flex-shrink-0 flex items-center justify-center text-[10px] font-bold">02</span>
                                    <span>**Zero-Knowledge Architecture**: We prioritize your privacy above all. We don't see what you don't share.</span>
                                </li>
                                <li className="flex gap-4 items-start">
                                    <span className="w-6 h-6 rounded-full bg-[#047857] text-cream flex-shrink-0 flex items-center justify-center text-[10px] font-bold">03</span>
                    ...
                    <div className="lg:col-span-6 flex items-center justify-center">
                        <div className="relative w-full max-w-md aspect-square bg-[#242424] p-12 flex items-center justify-center overflow-hidden">
                             ...
                             <div className="w-32 h-32 border-4 border-cream/20 rounded-full flex items-center justify-center relative z-10">
                                <div className="w-16 h-16 bg-cream rounded-sm transform rotate-45 flex items-center justify-center">
                                    <div className="w-4 h-4 bg-[#242424] rounded-full"></div>
                                </div>
                             </div>
                             <p className="absolute bottom-8 text-cream/40 font-mono text-[10px] uppercase tracking-[0.5em]">System Status: Fortified</p>
                        </div>
                    </div>
                </div>
            </FadeInSection>
            ...
            <FadeInSection>
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 border-t-4 border-black pt-12 mb-20">
                    <div className="lg:col-span-4">
                        ...
                        <ul className="space-y-4 font-bold text-xs uppercase tracking-widest text-[#242424]/70">
                    ...
                    <div className="lg:col-span-8">
                        ...
                        <div className="mt-12 bg-black text-cream p-8 flex flex-col md:flex-row justify-between items-center gap-8">
                             <div>
                             ...
                             <button className="bg-[#047857] text-cream px-8 py-4 font-bold text-xs uppercase tracking-widest hover:bg-cream hover:text-black transition-all cursor-pointer">
                                Join the Registry
                             </button>
                        </div>
                    </div>
