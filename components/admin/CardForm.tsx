        ...
        <div className="space-y-8">
          <div className="grid grid-cols-2 gap-6">
            ...
            <div>
              ...
              >
                ...
                {banks.map(b => (
                  <option key={b} value={b} className="bg-cream">{b}</option>
                ))}
              </select>
            </div>
          </div>
          ...
          <div>
              ...
              <input 
                  ...
                  className="w-full bg-white/5 border border-white/5 rounded-2xl p-4 focus:ring-2 focus:ring-clay outline-none transition-all text-white font-mono text-xs"
          ...
          <div className="grid grid-cols-3 gap-6">
            <div>
              ...
              <input 
                ...
                className="w-full bg-white/5 border border-white/5 rounded-2xl p-4 focus:ring-2 focus:ring-clay outline-none transition-all text-white"
              />
            </div>
            <div>
              ...
              <input 
                ...
                className="w-full bg-white/5 border border-white/5 rounded-2xl p-4 focus:ring-2 focus:ring-clay outline-none transition-all text-white font-bold"
              />
            </div>
            <div>
              ...
              <input 
                ...
                className="w-full bg-clay/10 border border-clay/20 rounded-2xl p-4 focus:ring-2 focus:ring-clay outline-none transition-all text-clay font-black"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              ...
              >
                ...
                {categories.map(c => (
                  <option key={c} value={c} className="bg-cream">{c}</option>
                ))}
              </select>
            </div>
            <div>
          ...
          <div className="relative aspect-[1.6/1] rounded-[2rem] overflow-hidden bg-white/5 border-2 border-dashed border-white/10 group flex items-center justify-center">
            ...
            <div className="absolute inset-0 bg-cream/60 opacity-0 group-hover:opacity-100 transition-all flex items-center justify-center backdrop-blur-sm">
              <button 
                ...
                className="bg-white text-cream p-5 rounded-full hover:scale-110 transition-transform shadow-2xl active:scale-95"
              >
                <Upload size={24} />
              </button>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div>
          ...
          <input 
            ...
            className="w-full bg-clay/10 border border-clay/20 rounded-2xl p-4 focus:ring-2 focus:ring-clay outline-none transition-all font-black text-clay placeholder:text-clay/30" 
          />
        </div>
        <div>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div key={idx} className="flex items-start gap-4 bg-white/5 p-6 rounded-[2rem] relative group/item border border-white/5">
                  <div className="flex-1 space-y-4">
                      <input 
                        ...
                        className="w-full bg-cream border border-white/10 rounded-xl p-3.5 text-sm font-black text-white focus:ring-2 focus:ring-clay outline-none placeholder:text-white/10"
                      />
                      <input 
                        ...
                        className="w-full bg-transparent border border-white/5 rounded-xl p-3.5 text-xs text-white/50 focus:ring-2 focus:ring-clay outline-none placeholder:text-white/5"
                      />
                  </div>
                  <button 
                    type="button" 
              ...
              <button 
                ...
                className="flex flex-col items-center justify-center border-2 border-dashed border-white/10 rounded-[2rem] p-8 hover:border-clay/50 transition-all group hover:bg-clay/5"
              >
          ...
          <div className="space-y-10 relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-cream border border-white/10 rounded-2xl p-4 text-sm text-white focus:ring-2 focus:ring-clay outline-none transition-all font-bold"
                />
              </div>
              <div>
            ...
            <div>
              ...
              <textarea 
                ...
                className="w-full bg-cream border border-white/10 rounded-2xl p-5 text-sm text-white/80 focus:ring-2 focus:ring-clay outline-none transition-all h-32 leading-relaxed font-serif italic"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <div className="space-y-6">
                <label className="block text-[10px] font-black uppercase tracking-[0.2em] text-clay flex items-center gap-2">
                  ...
                  {(form.grid_benefits || []).map((b: any, idx: number) => (
                    <div key={idx} className="flex gap-3">
                      ...
                      <input 
                        ...
                        className="w-2/3 bg-cream border border-white/10 rounded-xl p-3 text-xs text-white font-bold focus:ring-1 focus:ring-clay outline-none" 
                      />
                    </div>
                  ))}
                </div>
                  ...
                  {(form.pros || []).map((p: string, i: number) => (
                    <div key={i} className="flex gap-3 group">
                      <input 
                        ...
                        className="flex-1 bg-cream border border-clay/20 rounded-xl p-3.5 text-xs text-white" 
                      />
                  ...
                  {(form.cons || []).map((p: string, i: number) => (
                    <div key={i} className="flex gap-3 group">
                      <input 
                        ...
                        className="flex-1 bg-cream border border-red-500/20 rounded-xl p-3.5 text-xs text-white" 
                      />
                ...
                {(form.product_details || []).map((p: string, i: number) => (
                  <div key={i} className="flex gap-3 group">
                    <input 
                      ...
                      className="flex-1 bg-cream border border-white/10 rounded-xl p-3 text-xs text-white/80" 
                    />
                ...
                {(form.latest_news || []).map((n: string, i: number) => (
                  <div key={i} className="flex gap-3 group">
                    ...
                    <input 
                      ...
                      className="flex-1 bg-transparent border-b border-white/10 py-2 text-sm text-white/60 focus:text-white focus:border-clay outline-none transition-all" 
                    />
      ...
      <div className="space-y-8 pt-10 border-t border-white/5">
          <div>
            ...
            <textarea 
              ...
              className="w-full bg-white/5 border border-white/5 rounded-[2rem] p-8 focus:ring-2 focus:ring-clay outline-none transition-all h-40 text-[15px] leading-relaxed text-white placeholder:text-white/10 font-serif italic"
