    ...
    return (
        <div className="bg-cream min-h-screen text-ink pb-32">
            ...
            <div className="max-w-4xl mx-auto px-6 pt-16 md:pt-24 font-serif text-lg md:text-xl leading-relaxed text-ink/80 space-y-16">
                ...
                <section>
                    <p className="first-letter:text-6xl first-letter:font-bold first-letter:text-clay first-letter:mr-2 first-letter:float-left">
                        The website – ‘https://www.Yureka.Money’ and mobile application “Yureka.Money” and all other associated/ancillary applications, products, websites and services (“Website/Platform”) are owned and managed by Yureka.Money Solutions Private Limited, a company incorporated under the Companies Act, 2013 having its registered office address at M-2B Central Park Resorts, Sector 48, Gurugram, Haryana 122018.
                    </p>
                    <p className="mt-6">
                ...
                <section className="space-y-8">
                    ...
                    <p className="italic mb-4 text-base">
                        By using the platform, I grant unconditional consent to CRIF High Mark to deliver my Consumer Credit Information to Yureka.Money Solutions Private Limited on my behalf.
                    </p>
                ...
                <section className="space-y-6">
                    <h2 className="text-3xl font-bold uppercase tracking-tight text-ink border-b-2 border-black pb-4">HDFC ERGO Cyber Sachet Insurance</h2>
                    <p>This policy is valid for Customers of 'Yureka.Money' and offered by HDFC ERGO General Insurance Company (UIN: IRDAN125RP0026V02202122).</p>
                    
                    <div className="overflow-x-auto border border-black/10 mt-6">
                        <table className="w-full text-left text-sm md:text-base border-collapse">
                            <thead className="bg-[#111111] text-white">
                                <tr>
                                    <th className="p-4 uppercase tracking-widest text-[10px] font-bold">Coverage Area</th>
                                    <th className="p-4 uppercase tracking-widest text-[10px] font-bold">Details</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-black/10 bg-white">
                                <tr className="hover:bg-black/5 transition-colors">
                                    <td className="p-4 font-bold text-ink">Theft of Funds (Digital)</td>
                                    <td className="p-4 italic text-sm">Covers financial loss due to unauthorized digital access to the Insured’s bank account through UPI, Wallets, Net-Banking, or Cards due to phishing or spoofing.</td>
                                </tr>
                                <tr className="hover:bg-black/5 transition-colors">
                                    <td className="p-4 font-bold text-ink">Identity Theft</td>
                                    <td className="p-4 italic text-sm">Covers financial loss and expense incurred on credit monitoring services and legal services necessitated by the wrongful use of personal data.</td>
                                </tr>
                                <tr className="hover:bg-black/5 transition-colors">
                                    <td className="p-4 font-bold text-ink">Key Exclusions</td>
                                    <td className="p-4 italic text-sm font-mono text-xs">Unauthorized physical transactions, International Transactions, Trading losses, Gambling online, Epidemics/Pandemics.</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <section className="border-t-4 border-black pt-16 mt-16 text-center space-y-8">
                     ...
                     <div className="pt-8">
                         ...
                         <p className="italic text-ink/60 mb-2">Grievance Redressal Officer (per DPDP Rule 12 & IT Rules): Mr. Ashish Lath</p>
                         <p className="italic text-ink/60 mb-6">+91 9818600939 • T-M/2B, 2ND FLOOR, CENTRAL PARK II, GURGAON 122018</p>
            ...
            <div className="max-w-4xl mx-auto px-6 mt-24 flex items-center justify-center gap-4 text-xs font-mono uppercase tracking-widest text-ink/30">
                ...
                <span>•</span>
                <span>Company: Yureka.Money Solutions Pvt Ltd</span>
            </div>
        </div>
    );
};
