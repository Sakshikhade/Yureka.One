  ...
  return (
    <section className="py-24 bg-[#0a0a0a] border-y border-white/10 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col gap-0">
          ...
          {/* Row 1: Right to Left */}
          <div className="bg-white text-[#0a0a0a] py-3 border-y border-white/10 transform -rotate-1 scale-105 shadow-xl origin-center">
             <div className="flex whitespace-nowrap animate-marquee w-max" style={{ animationDuration: '44s' }}>
                 {[...Array(6)].map((_, i) => (
                    <div key={i} className="flex items-center gap-10 px-6">
                        ...
                        <div className="w-3 h-3 bg-[#0a0a0a] rounded-full opacity-60"></div>
                    </div>
                 ))}
             </div>
          </div>
          ...
          {/* Row 2: Left to Right */}
          <div className="bg-[#34d399] text-[#0a0a0a] py-3 border-y border-black/10 transform rotate-1 scale-105 shadow-xl origin-center mt-[-8px] z-20">
