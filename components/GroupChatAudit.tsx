  ...
  return (
    <div className="w-full h-full flex items-center justify-center p-4">
      <motion.div 
        ...
        viewport={{ once: true }}
        className="mx-auto w-full max-w-[300px] sm:max-w-[320px] aspect-[9/18.5] bg-ink rounded-[3rem] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] border-[8px] border-[#222] relative overflow-hidden flex flex-col"
      >
        {/* Notch */}
