...
const CareersPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-[#0a0a0a] pt-4 md:pt-8 pb-20 font-sans text-white overflow-x-hidden selection:bg-[#34d399] selection:text-[#0a0a0a]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-4">
                <FadeInSection>
                    <div className="bg-white/5 border border-white/10 p-8 mb-8 shadow-sm rounded-3xl backdrop-blur-sm">
                        <h3 className="text-2xl font-serif mb-4 text-[#34d399] italic">Why join?</h3>
                        ...
                        <ul className="space-y-3 text-sm font-mono text-white/80">
                            <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-[#34d399] rounded-full shadow-[0_0_8px_#34d399]"></div> High Autonomy</li>
                            <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-[#34d399] rounded-full shadow-[0_0_8px_#34d399]"></div> Competitive Equity</li>
                            <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-[#34d399] rounded-full shadow-[0_0_8px_#34d399]"></div> Beautiful Office</li>
                        </ul>
                    </div>
            ...
            <div className="lg:col-span-8">
                <div className="border border-white/10 bg-white/5 shadow-sm rounded-3xl overflow-hidden backdrop-blur-sm">
                    ...
                    {roles.map((role, idx) => (
                        <FadeInSection key={idx} delay={idx * 50}>
                            <div className="flex flex-col md:grid md:grid-cols-12 border-b border-white/5 hover:bg-[#34d399] hover:text-[#0a0a0a] transition-all duration-300 py-8 px-6 md:items-center group cursor-pointer text-white">
                                <div className="md:col-span-2 font-mono text-xs opacity-50 mb-2 md:mb-0 group-hover:text-[#0a0a0a]/60">{role.id}</div>
                                <div className="md:col-span-5 mb-4 md:mb-0">
                                    <h3 className="text-xl font-heading font-extrabold group-hover:text-[#0a0a0a]">{role.title}</h3>
                                ...
                                <div className="md:col-span-2 text-left md:text-right">
                                    <button className="w-10 h-10 border border-white/20 group-hover:border-[#0a0a0a]/20 rounded-full flex items-center justify-center md:ml-auto group-hover:rotate-45 transition-transform">
                ...
                <div className="mt-12 text-center p-12 border border-dashed border-white/10 rounded-3xl bg-white/5 backdrop-blur-sm">
                    ...
                    <a href="mailto:careers@yureka.money" className="text-[#34d399] font-serif italic text-2xl underline hover:text-white transition-colors decoration-1 underline-offset-8">Email the Editor</a>
                </div>
            </div>
