                ...
                <div className="flex-1 pt-6 px-2 flex flex-col justify-between">
                    ...
                    <div className="flex items-end justify-between mt-auto">
                        ...
                        <Link 
                            ...
                            className="w-12 h-12 border border-ink/10 text-ink flex items-center justify-center hover:bg-ink hover:text-white transition-all rounded-full shadow-md hover:shadow-xl hover:-translate-y-1"
                            aria-label={`Analysis of ${card.name}`}
                        >
