      ...
      <div className="max-w-[1440px] mx-auto px-6 mb-12 md:mb-20 border-b border-black/10 pb-12 md:pb-20">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12">
              ...
              <div className="lg:col-span-4 flex flex-col justify-end items-start lg:items-end">
                  <div className="border border-black/20 p-6 md:p-8 w-full max-w-sm hover:bg-clay hover:text-white transition-colors group cursor-pointer bg-white">
      ...
      <div className="max-w-[1440px] mx-auto px-6 mb-12 md:mb-20">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 border-l border-black/10">
              ...
              <div className="pl-6 md:pl-8 border-r border-black/10 min-h-[150px] md:min-h-[200px]">
                  ...
                  <ul className="space-y-3 md:space-y-4">
                      <li><a href="#" className="hover:text-teal font-serif text-sm md:text-base transition-colors">Terms of Service</a></li>
                      <li><a href="#" className="hover:text-teal font-serif text-sm md:text-base transition-colors">Privacy Policy</a></li>
                      <li><a href="#" className="hover:text-teal font-serif text-sm md:text-base transition-colors">Security Protocol</a></li>
                      <li><a href="#" className="hover:text-teal font-serif text-sm md:text-base transition-colors">Community Guidelines</a></li>
                  </ul>
              </div>
              ...
              <div className="pl-6 md:pl-8 border-r border-black/10 min-h-[150px] md:min-h-[200px] col-span-1 sm:col-span-2 md:col-span-1 lg:col-span-2">
                  ...
                  <div className="flex gap-3 md:gap-4">
                        {[Instagram, Linkedin, Twitter, Facebook].map((Icon, i) => (
                             <a key={i} href="#" aria-label="Social Link" className="w-8 h-8 md:w-10 md:h-10 border border-black/20 flex items-center justify-center text-black hover:bg-clay hover:text-white transition-all">
