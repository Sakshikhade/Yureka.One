  ...
  return (
    <section ref={sectionRef} className="bg-[#0C0C0C] pt-24 sm:pt-32 md:pt-40 pb-10 overflow-hidden w-full">
      <div className="flex flex-col gap-3">
        ...
        >
          {r1.map((url, i) => (
            <img key={`r1-${i}`} src={url} alt="" loading="lazy"
              className="w-[260px] h-[167px] sm:w-[360px] sm:h-[232px] md:w-[420px] md:h-[270px] rounded-2xl object-cover flex-shrink-0"
            />
          ))}
        </div>
        <div
        ...
        >
          {r2.map((url, i) => (
            <img key={`r2-${i}`} src={url} alt="" loading="lazy"
              className="w-[260px] h-[167px] sm:w-[360px] sm:h-[232px] md:w-[420px] md:h-[270px] rounded-2xl object-cover flex-shrink-0"
            />
          ))}
        </div>
...
const ServicesSection: React.FC = () => (
  <section className="bg-white text-[#0C0C0C] rounded-t-[40px] sm:rounded-t-[50px] md:rounded-t-[60px] py-20 sm:py-24 md:py-32 relative z-10 w-full overflow-hidden">
    <ColContent className="flex flex-col items-center">
      <h2
        className="text-[#0C0C0C] font-black uppercase text-center mb-16 sm:mb-20 md:mb-28 tracking-tight leading-none w-full"
        style={{ fontSize: 'clamp(3rem, 10vw, 120px)' }}
      >
        Services
      </h2>
