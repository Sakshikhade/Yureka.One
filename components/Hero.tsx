...
import { ArrowRight, Globe, Calendar, Cloud, Wind, Sparkles } from 'lucide-react';

const Hero: React.FC = () => {
  return (
    <section className="relative w-full min-h-screen flex flex-col items-center pt-16 pb-20 bg-cream border-b border-ink/10 overflow-hidden">
            ...
            <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-0 border-t border-ink/10">
                ...
                <div className="lg:col-span-3 border-r border-ink/10 pr-6 pt-8 hidden lg:block opacity-0 animate-fade-in-up delay-300">
                     ...
                     <div className="mt-12 bg-ink/5 p-6 border border-ink/10">
                         <h5 className="font-bold text-xs uppercase tracking-widest text-teal mb-4">Your Potential Savings</h5>
                         <div className="flex justify-between text-sm text-ink/70 border-b border-ink/10 py-3">
                             <span>Average Savings</span>
                             <span className="text-teal font-bold">₹15k/yr</span>
                         </div>
