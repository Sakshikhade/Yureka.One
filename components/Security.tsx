        ...
        <section className="py-32 bg-cream border-t border-black/10 relative flex items-center justify-center overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto w-full px-6 text-[#242424]">
                ...
                <motion.div 
                    ...
                    className="relative border border-ink/10 bg-[#242424] p-12 md:p-32 text-center cursor-crosshair group overflow-hidden shadow-2xl rounded-sm"
                >
                    <div className="absolute top-12 right-12 opacity-[0.03]">
                        <Fingerprint size={160} className="text-cream" />
                    </div>

                    {/* Masked Content (Dimmed) */}
                    <div className="relative z-10 transition-all duration-700 opacity-90 group-hover:opacity-40 group-hover:blur-sm text-cream">
                        ...
                        <p className="font-serif text-xl md:text-2xl italic max-w-xl mx-auto text-cream/60 leading-relaxed">
                            We use bank-grade encryption for every match. We do not sell, share, or monetize your spending patterns. 
                        </p>
                        <div className="mt-12 inline-block border border-cream/20 px-8 py-3 text-[9px] font-bold uppercase tracking-[0.4em] rounded-full text-cream/40">
                    ...
                    {/* Torch Reveal Layer */}
                    <motion.div 
                        className="absolute inset-0 bg-cream text-[#242424] flex items-center justify-center pointer-events-none z-20"
                        style={{
                    ...
                    >
                         <div className="p-12 md:p-20 text-center">
                            ...
                            <p className="font-serif text-xl md:text-2xl italic max-w-xl mx-auto text-[#242424]/80 leading-relaxed">
                                We use bank-grade encryption for every match. We do not sell, share, or monetize your spending patterns. 
                            </p>
                            <div className="mt-12 inline-block bg-[#242424] text-cream px-8 py-3 text-[9px] font-bold uppercase tracking-[0.4em] rounded-full shadow-xl">
                                Verified Secure Protocol
                            </div>
                         </div>
                    </motion.div>
