                ...
                >
                    ...
                    <div className="relative z-10 text-center">
                        <h3 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white tracking-tight leading-tight mb-16 uppercase italic">
                            ...
                            <span className="text-emerald-400 font-light">away</span>, even from us
                        </h3>
                        ...
                        <div className="relative h-[250px] md:h-[350px] w-full max-w-4xl mx-auto mb-16 flex items-center justify-center">
                            ...
                            <div className="relative w-[300px] h-[180px] md:w-[480px] md:h-[280px]">
                                ...
                                <div className="absolute inset-0 bg-[#050505] rounded-2xl border border-emerald-500/20 overflow-hidden shadow-[inset_0_0_50px_rgba(0,0,0,1)]">
                                    {/* Terminal Background */}
                                    <div className="absolute inset-0 flex flex-col p-6 opacity-80">
                                        ...
                                        <div className="absolute left-0 top-0 bottom-0 w-1/3 opacity-[0.05] pointer-events-none overflow-hidden select-none">
                                            ...
                                            >
                                                {[...Array(100)].map((_, i) => (
                                                    <div key={i} className="text-[8px] font-mono text-emerald-400 whitespace-nowrap">
                                        ...
                                        <div className="space-y-3 opacity-60 overflow-hidden relative z-10">
                                            ...
                                            {[...Array(4)].map((_, i) => (
                                                <div key={i} className="flex gap-3 whitespace-nowrap items-center">
                                                    <div className="w-1 h-4 bg-emerald-500/10" />
                                                    <span className="text-[10px] font-mono text-emerald-400/80">
                                                        [0x<EncryptedText text={i === 0 ? "SHIELD" : Math.random().toString(16).slice(2, 6).toUpperCase()} />]
                                                    </span>
                                                    <span className="text-[9px] font-mono text-emerald-400/10">{" -> "} ENCRYPT_LAYER_{i + 1}</span>
                                                </div>
                                            ))}
                                        </div>

                                        <div className="text-2xl md:text-4xl font-mono text-emerald-400 drop-shadow-[0_0_20px_rgba(52,211,153,0.3)] tracking-[0.25em] relative z-10 mt-auto border-l-4 border-emerald-500/30 pl-6 py-2 bg-emerald-500/[0.03]">
                                    ...
                                    <motion.div 
                                        ...
                                        className="absolute inset-x-0 h-24 bg-gradient-to-b from-transparent via-emerald-400/30 to-transparent pointer-events-none z-10"
                                    />
                                </div>
                                    ...
                                    <div className="p-8 md:p-12 h-full flex flex-col justify-between">
                                        ...
                                        <div className="flex justify-between items-end">
                                            ...
                                            <div className="flex -space-x-3">
                                                ...
                                                <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-emerald-500/10 border border-emerald-500/5" />
                                            </div>
                                        </div>
                                    </div>
                                </motion.div>
                                ...
                                <motion.div 
                                    ...
                                    className="absolute top-[-15%] bottom-[-15%] w-[4px] bg-emerald-400 z-30 shadow-[0_0_20px_#34d399,0_0_40px_rgba(52,211,153,0.6)]"
                                >
                                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-5 h-5 bg-emerald-400 blur-md rounded-full" />
                                    <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-5 h-5 bg-emerald-400 blur-md rounded-full" />
                                    <div className="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 bg-black border-2 border-emerald-400 p-3 rounded-2xl shadow-2xl text-emerald-400 z-40 transform scale-90 md:scale-110">
                                        <Lock size={28} />
                                    </div>
                                </motion.div>
                            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 text-left max-w-5xl mx-auto relative z-10">
                            {features.map((f, i) => (
                                <motion.div 
                                    ...
                                    className="bg-white/[0.02] backdrop-blur-xl border border-white/10 p-8 rounded-[2.5rem] hover:bg-white/[0.05] hover:border-emerald-500/30 transition-all duration-500 group shadow-2xl relative"
                                >
                                    <div className="absolute -top-[2px] left-1/2 -translate-x-1/2 w-16 h-[2px] bg-emerald-500/0 group-hover:bg-emerald-500/50 transition-all duration-700 blur-[3px]" />
                                    
                                    <div className="mb-6 w-14 h-14 rounded-2xl bg-emerald-500/5 flex items-center justify-center transform group-hover:scale-110 group-hover:bg-emerald-500/10 transition-all duration-500 border border-emerald-500/10">{f.icon}</div>
                                    ...
                                    <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-7 h-7 bg-black border border-emerald-500/30 rounded-full flex items-center justify-center shadow-[0_0_15px_rgba(52,211,153,0.2)]">
