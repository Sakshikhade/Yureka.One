...
const Clients: React.FC = () => {
  ...
  return (
    <section className="bg-[#0d4428] py-16 overflow-hidden relative w-full border-t border-b border-white/5">
      <div className="max-w-6xl mx-auto px-4 md:px-8 mb-10 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <span className="px-3 py-1 rounded-full bg-white/5 border border-white/10 text-[10px] font-bold tracking-widest text-[#def46e] uppercase select-none">
            Interested
          </span>
      ...
      <div className="relative w-full flex items-center overflow-hidden">
        ...
        <div className="absolute left-0 top-0 bottom-0 w-24 md:w-48 bg-gradient-to-r from-[#0d4428] to-transparent z-10 pointer-events-none" />
        
        {/* Right Fade Gradient Mask */}
        <div className="absolute right-0 top-0 bottom-0 w-24 md:w-48 bg-gradient-to-l from-[#0d4428] to-transparent z-10 pointer-events-none" />
        ...
        >
          {tickerItems.map((client, idx) => {
            ...
            return (
              ...
              >
                <IconComponent size={24} className="group-hover:text-[#def46e] transition-colors" />
