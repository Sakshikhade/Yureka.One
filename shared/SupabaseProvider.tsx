...
export const SupabaseProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // Auth client not wired yet — open dashboard access for Goldback v1 with a local demo identity.
  // When VITE_SUPABASE_ANON_KEY is set, replace this with real Supabase Auth + waitlist status.
  useEffect(() => {
    const demoUser = {
      id: 'demo-user',
      email: 'demo@yureka.one',
      user_metadata: { full_name: 'Goldback Explorer' },
    };
    setUser(demoUser);
